...
struct [[ potato::table, potato::contract("pocker") ]] st_bet_stats
{
   uint64_t id;
   name player;
   asset amount;
...
struct [[ potato::table, potato::contract("pocker") ]] st_bet_clearing_stats
{
   uint64_t id;
   uint64_t bet_id;
   asset amount;
...
struct [[ potato::table, potato::contract("pocker") ]] st_mybet_clearing_stats
{
   uint64_t id;
   uint64_t bet_id;
   asset amount;
...
class[[potato::contract("pocker")]] pocker : public contract
{
public:
   ...
   static constexpr potato::name pocker_edge{"pocker.edge"_n};
   static constexpr potato::symbol token_symbol{symbol_code("POC"), 4};

   pocker(name receiver, name code, datastream<const char *> ds);
